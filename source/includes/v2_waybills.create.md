...
```json
{
  ...
  "parcels_inbound": 0,
  "parcels_inbound_percentage": "0%",
  "parcels_released": 0,
  "parcels_released_percentage": "0 %",
  "parcels_outbound": 0,
  "parcels_outbound_percentage": "0%",
  "job_state": "uploading",
...
| `shipping_method`     | <span class="type">string</span> | <span class="required_if">Required If</span> <span class="required_if">Account is set to using shipping methods.</span> Id of the shipping method (destination) of the parcel.                                                                                       |
